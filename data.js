window.HISTORICAL_DATA = [
  ...
  legacy: "Ông mang giá trị hiện tại ở việc củng cố ý thức cội nguồn, nuôi dưỡng tinh thần đoàn kết dân tộc; thể hiện khát vọng xây dựng quốc gia có chủ quyền; đồng thời khơi dậy niềm tự hào, trách nhiệm gìn giữ bản sắc và phát triển đất nước bền vững trong thời đại hội nhập.",
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1599707334391-702214420712?auto=format&fit=crop&q=80&w=1000",
        side: "left",
        summary: "Hai Bà Trưng (Trưng Trắc và Trưng Nhị) là hai nữ anh hùng dân tộc, lãnh đạo cuộc khởi nghĩa năm 40 đánh đuổi ách đô hộ nhà Đông Hán, giành lại quyền tự chủ cho đất nước sau hơn 200 năm Bắc thuộc.",
        biography: "Hai Bà Trưng quê ở Mê Linh (nay thuộc Hà Nội), là con của một Lạc tướng — người có thế lực và uy tín lớn trong vùng. Trưng Trắc (chị, sinh khoảng năm 14) và Trưng Nhị (em) từ nhỏ đã được giáo dục bài bản, giỏi võ nghệ, sớm có ý thức về danh dự và lòng yêu nước, không chịu khuất phục trước cường quyền. Trưng Trắc kết hôn với Thi Sách — con Lạc tướng Chu Diên, người cùng chí hướng chống lại ách đô hộ. Khi Thi Sách bị thái thú Tô Định sát hại, đó trở thành ngòi lửa trực tiếp châm bùng cuộc khởi nghĩa lịch sử.",
        activities: "Dưới thời Bắc thuộc, thái thú Tô Định cai trị tàn bạo, thuế khóa nặng nề, gây bất bình sâu sắc trong nhân dân. Năm 40, Hai Bà phất cờ khởi nghĩa tại Hát Môn (Hà Nội), nhanh chóng thu hút sự hưởng ứng rộng khắp từ các Lạc tướng và dân chúng. Chỉ trong thời gian ngắn, nghĩa quân đã chiếm được 65 thành trì, đánh đuổi toàn bộ quan lại nhà Hán ra khỏi bờ cõi. Trưng Trắc lên ngôi vua, đóng đô tại Mê Linh, thiết lập chính quyền tự chủ — trang sử độc lập đầu tiên sau hơn 200 năm nô lệ. Năm 42–43, nhà Đông Hán cử danh tướng Mã Viện dẫn đại quân sang đàn áp. Dù Hai Bà lãnh đạo kháng chiến kiên cường, song lực lượng quá chênh lệch, cuộc khởi nghĩa kết thúc vào năm 43.",
        legacy: `Cuộc khởi nghĩa của Hai Bà Trưng là cuộc nổi dậy đầu tiên trong lịch sử Việt Nam do phụ nữ lãnh đạo và giành thắng lợi — một kỳ tích hiếm có trên thế giới thời bấy giờ. Sự kiện này không chỉ khẳng định chủ quyền dân tộc mà còn tạo tiền đề, cổ vũ mạnh mẽ cho hàng loạt phong trào đấu tranh giành độc lập về sau như khởi nghĩa Bà Triệu, Lý Bí, Triệu Quang Phục... <img src="https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&q=80&w=800" alt="Đền thờ Hai Bà Trưng"> Ngày nay, hình tượng Hai Bà được thờ phụng tại hàng trăm đền thờ trên khắp cả nước, trở thành biểu tượng bất diệt của tinh thần yêu nước, bình đẳng giới và ý chí quật cường.`
    }
];
